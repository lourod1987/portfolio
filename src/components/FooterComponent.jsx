      ...
      <ul className='flex flex-row justify-center'>
        {
          socials.map((social, i) => {
            return (
              <li key={`social-${i}`} className='ring-4 ring-[#e63946] m-3 rounded-md bg-[#e3def4] transition delay-150 duration-200 ease-in-out hover:-translate-y-1 hover:scale-115 hover:bg-[#e63964]'>
