function SkillListComponent(props) {
  ...
  const skillList = skills.map((skill, i) => {
    return (
      <li key={`skill-${i}`} className='ring-4 ring-[#e63946] m-3 rounded-md bg-[#e3def4] transition delay-150 duration-400 ease-in-out hover:-translate-y-1 hover:scale-115 hover:bg-[#e63964]'>
